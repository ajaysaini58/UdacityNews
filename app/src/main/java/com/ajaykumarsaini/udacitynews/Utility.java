...
public class Utility {
    ...
    private static final int RESPONSE_CODE_OK = 200;  // Ok response code
    private static final int CONNECTION_TIMEOUT = 15000; // Time in millisecond
    private static final int READ_TIMEOUT = 10000;       // Time in millisecond
    ...
    private static List<NewsItem> parseJSON(String response) throws JSONException {
        ...
        for (int i = 0; i < resultsArray.length(); i++) {
            ...
            newsItems.add(new NewsItem(title, section, author, pubDate, url));
        }
        return newsItems;
    }
